...
```{r}
 ...
 out13  <- read.csv(here::here("out", paste0("00.4.9_kmeans_13cl_ts" , ".csv"))) |> mutate(date = as_date(date))
  out20<- read.csv(here::here("out", paste0("00.4.9_kmeans_20cl_ts" , ".csv"))) |> mutate(date = as_date(date))
